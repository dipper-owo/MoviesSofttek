package com.jersson.diaz.moviessofttek.di

import android.content.Context
import androidx.room.Room
import com.jersson.diaz.moviessofttek.data.local.MovieDataBase
import com.jersson.diaz.moviessofttek.data.local.MovieRepository
import com.jersson.diaz.moviessofttek.data.local.datasource.MovieDatabaseDataSource
import com.jersson.diaz.moviessofttek.data.remote.network.MovieApiClient
...
object DataModule {
    ...
    @Provides
    fun provideMovieRepository(movieDatabaseDataSource: MovieDatabaseDataSource): IMovieRepository {
        return MovieRepository(movieDatabaseDataSource = movieDatabaseDataSource)
    }

    @Provides
    fun provideMovieDatabaseDataSource(movieDataBase: MovieDataBase): MovieDatabaseDataSource {
        return MovieDatabaseDataSource(movieDataBase = movieDataBase)
    }
}
